...
| `missing required scope(s)` | — | 应用缺少权限 | 按 [`../../lark-shared/SKILL.md`](../../lark-shared/SKILL.md) 的非阻塞认证规则在后台发起 `auth login --scope "minutes:minutes.media:export"` 并返回授权链接；不要让最终用户执行命令 |
